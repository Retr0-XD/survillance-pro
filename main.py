...
frame1 = tk.Frame(window, bg='#121212')

label_title = tk.Label(frame1, text="Smart Survillance")
...
btn2 = tk.Button(frame1, text='Obj Track', height=90, width=180, fg='green', command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
btn2.grid(row=3, pady=(20,20), column=3, padx=(20,10))
...
btn5 = tk.Button(frame1, height=90, width=180, fg='red', command=window.quit, image=btn5_image, background='#D0342C')
btn5['font'] = btn_font
btn5.grid(row=6, pady=(20,10), column=2)

btn7 = tk.Button(frame1, text="identify", fg="green",command=maincall, compound='left', image=btn7_image, height=90, width=180)
btn7['font'] = btn_font
